# Fluent / native — what changes

The applicant does not need language repair. Spend the effort on rhetoric,
specificity, and structure — the things that actually distinguish statements.
...
- **Preserve and sharpen the applicant's own idiom.** If they provided a draft
  or sample, keep their voice and rhythm. Edit toward *their* best version, not
  a uniform "polished" register.
...
- Keep some sentence-level roughness and variety. Relentless polish is itself a
  tell and flattens the human voice.
